...
const baseProductsCatalog = [
  ...
  {
    id: 'HOME009',
    name: 'Voltas 1.5 Ton 5 Star Inverter Split AC (Copper, 4-in-1 Adjustable Mode)',
    brand: 'Voltas',
    category: 'Home & Kitchen',
    ...
    specifications: { 'Capacity': '1.5 Ton', 'Energy Rating': '5 Star', 'Cooling Capacity': '5100 W', 'Refrigerant': 'R32', 'Condenser': '100% Copper', 'Warranty': '1 Year Comprehensive, 10 Years Compressor' },
    seller: 'Voltas Official Store',
    stock: 35,
  },
  {
    id: 'HOME010',
    ...
    specifications: { 'Capacity': '236 Litres', 'Energy Rating': '3 Star', 'Defrost System': 'Frost Free', 'Compressor': 'Digital Inverter', 'Shelves': 'Toughened Glass', 'Color': 'Silver Elegance' },
  ...
  },
  {
    ...
    features: ['7 Kg Capacity', '5 Star Energy Rating', 'AI Direct Drive', '6 Motion DD Tech', 'Steam Wash (Allergy Care)', '1200 RPM Spin Speed'],
    specifications: { 'Capacity': '7.0 Kg', 'Type': 'Front Load Fully-Automatic', 'Max Spin Speed': '1200 RPM', 'Programs': '14 Wash Cycles', 'Motor': 'Direct Drive Inverter', 'Warranty': '2 Years on Product, 10 Years on Motor' },
  ...
  },
  {
    ...
    features: ['28L Capacity', 'Convection + Grill + Solo', 'Charcoal Lighting Heater', '251 Auto Cook Menus', 'Ghee Maker in 12 Mins', 'Pasteurized Milk Program'],
    specifications: { 'Capacity': '28 Litres', 'Cavity': 'Stainless Steel', 'Control': 'Tactile Buttons & Dial', 'Wattage': '1950W', 'Warranty': '1 Year on Product, 4 Years on Magnetron' },
